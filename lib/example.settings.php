 ...
 * @endcode
 */
$settings['hash_salt'] = '2FC_d-wG5SS4kLOqMM5bZFsuF4xAAR0O7Tw2q4ccgHm3G3qKwZmk7IL0MPtxl0jEURWRdJX6-Q';
...
$settings['redis.connection']['host'] = 'redis';        // Your Redis instance host name or IP ('localhost' is fine)
...
$d4dd_settings = __DIR__ . '/settings.d4dd.php';
if (file_exists($d4dd_settings)) {
  include $d4dd_settings;
}
