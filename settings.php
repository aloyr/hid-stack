...
$conf['environment_indicator_text'] = 'DEV | PETER';
$conf['environment_indicator_color'] = 'dark-red';
$conf['environment_indicator_enabled'] = TRUE;
$conf['stage_file_proxy_origin'] = 'https://www.hidglobal.com';
$conf['stage_file_proxy_origin_dir'] = 'sites/default/files';
$conf['page_compression'] = FALSE;
$databases['default']['default'] = array('driver' => 'mysql','database' => 'hid','username' => 'hid','password' => 'hid','host' => 'db','prefix' => '',);
$conf['language_domains']['en'] = 'http://www.hidglobal.dev';
$conf['language_domains']['de'] = 'http://de.hidglobal.dev';
$conf['language_domains']['es'] = 'http://es.hidglobal.dev';
$conf['language_domains']['fr'] = 'http://fr.hidglobal.dev';
$conf['language_domains']['it'] = 'http://it.hidglobal.dev';
$conf['language_domains']['ja'] = 'http://ja.hidglobal.dev';
$conf['language_domains']['ko'] = 'http://ko.hidglobal.dev';
$conf['language_domains']['pt-br'] = 'http://pt-br.hidglobal.dev';
$conf['language_domains']['ru'] = 'http://ru.hidglobal.dev';
$conf['language_domains']['th'] = 'http://th.hidglobal.dev';
$conf['language_domains']['zh-hans'] = 'http://zh-hans.hidglobal.dev';
...
$conf['cache_prefix'] = 'hidglobal.dev';
